...
if DEBUG_MAPPINGS:
    ...
    AQUIFER_PVACD_MAP = readjson(
        "https://raw.githubusercontent.com/NMWDI/VocabService/main/pvacd_hydroviewer/mappings/3dmodel_to_PVACD.json"
    )
...
if DEBUG_MAPPINGS:
    ...
    AQUIFER_3DMODEL_MAP = readjson(
        "https://raw.githubusercontent.com/NMWDI/VocabService/main/pvacd_hydroviewer/mappings/formationCode_to_3dmodel.json"
    )
# ============= EOF =============================================
